...
public class JwtTokenProvider {
    ...
    // A secure 256-bit key string for HS256 validation compliance
    ...
    private final long validityInMilliseconds = 3600000 * 24; // Token expiration set to 24 hours
    ...
    public boolean validateToken(String token) {
        try {
            ...
            return false; // Returns false if token is expired, tampered, or structurally invalid
        }
    }
}