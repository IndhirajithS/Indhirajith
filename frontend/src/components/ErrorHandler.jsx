...
export const ErrorHandler = ({ error, onDismiss }) => {
  ...
  return (
    <div className="bg-rose-950/90 border border-rose-800 text-rose-200 p-4 rounded-xl shadow-lg flex items-center justify-between my-4 backdrop-blur-md" role="alert">
